/**
 * @file This file contains Mocha and Chai tests for the tsunami' related API endpoints.
 * @author Ben Mahoney
 */
  ...
  it("should not update Tsunami by id", (done) => {
    chai
      ...
      .end((req, res) => {
        chai
          .expect(res.body.msg)
          .to.be.equal("No tsunami with the id: 3 found");
        done();
      });
  });
  ...
  it("should delete Tsunami by id", (done) => {
    chai
      ...
      .end((req, res) => {
        ...
        chai
          .expect(res.body.msg)
          .to.be.equal("Tsunami with the id: 1 successfully deleted");
        done();
      });
  });
});

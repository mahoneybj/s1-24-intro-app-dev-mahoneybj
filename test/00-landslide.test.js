...
describe("Landslide", () => {
    it("should not create Landslide", (done) => {
      chai
        ...
        .end((req, res) => {
          chai.expect(res.body.msg).to.be.equal("Number of landslides should be a int");
          done();
        });
    });
    ...
    it("should delete Landslide by id", (done) => {
      chai
        ...
        .end((req, res) => {
          chai.expect(res.status).to.be.equal(200);
          chai.expect(res.body).to.be.a("object");
          chai.expect(res.body.msg).to.be.equal("Landslide with the id: 1 successfully deleted");
          done();
        });
    });
  });

/**
 * @file This file contains Mocha and Chai tests for the earthquake early warning related API endpoints.
 * @author Ben Mahoney
 */
  ...
  it("should not create EEWInfo (validation)", (done) => {
    chai
      ...
      .end((req, res) => {
        chai
          .expect(res.body.msg)
          .to.be.equal("Alert triggered should be a boolean");
        done();
      });
  });
  ...
  it("should not update EEWInfo by id", (done) => {
    chai
      ...
      .end((req, res) => {
        chai
          .expect(res.body.msg)
          .to.be.equal("No EEW info with the id: 3 found");
        done();
      });
  });
  ...
  it("should delete EEWInfo by id", (done) => {
    chai
      ...
      .end((req, res) => {
        ...
        chai
          .expect(res.body.msg)
          .to.be.equal("EEW info with the id: 1 successfully deleted");
        done();
      });
  });
});

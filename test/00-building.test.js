    ...
    it("should create building damage", (done) => {
      chai
        ...
        .end((req, res) => {
          ...
          chai.expect(res.body.msg).to.be.equal("Building damage log successfully created");
          done();
        });
    });
    ...
    it("should delete building damage by id", (done) => {
      chai
        ...
        .end((req, res) => {
          chai.expect(res.status).to.be.equal(200);
          chai.expect(res.body).to.be.a("object");
          chai.expect(res.body.msg).to.be.equal("Building damage log with the id: 1 successfully deleted");
          done();
        });
    });
  });
